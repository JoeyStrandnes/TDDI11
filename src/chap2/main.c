...
{	
	...
	while(true)
	{
		...
		//fanMask = 0x00000007; //0b002500 0111 1111
		//fanSpeedSelector =  fanSpeedSelector & fanMask;
		fanSpeedSelector &=  0x07;
...
//Assignment
		...
		unsigned int temperatureMeasured_fractional = ((0x07) & (inputRegister>>10)); // Assignment
		//temperatureMeasured_fractional = 0x00000000; // Assignment
		// bits 13 to 17 are decimal part
		unsigned int temperatureMeasured_decimal = ((0x1F) & (inputRegister>>13)); // Assignment
...
//Assignment
		if(fanSpeedSelector == 0x0)
			fanSpeed = (1 << 3 | 1 << 2); // Assignment
		else if (fanSpeedSelector == 0x05) // Assignment
			fanSpeed = (1 << 3 | 0 << 2); // Assignment
		else if (fanSpeedSelector == 0x03) // Assignment
			fanSpeed = (1 << 2); // Assignment
		else
